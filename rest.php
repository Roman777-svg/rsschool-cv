...
define('CRM_HOST', 'wcs.bitrix24.ua'); // your CRM domain name
define('CRM_PORT', '443'); // CRM server port
define('CRM_PATH', '/crm/configs/import/lead.php'); // CRM server REST service path

// CRM server authorization data
define('CRM_LOGIN', 'rolros8@gmail.com'); // login of a CRM user able to manage leads
define('CRM_PASSWORD', 'zibob778899'); // password of a CRM user
...
<form action="rest.php" method="post">
	...
	Company Name: <input type="text" name="DATA[EMAIL_WORK]" value="" /><br />
	First Name: <input type="text" name="DATA[NAME]" value="" /><br />
	Last Name: <input type="text" name="DATA[PHONE_OTHER]" value="" /><br />
